...
import com.example.myuniver.service.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignupStudentRequest signUpRequest) {
        ...
        Long group_id = groupRepository.findIdBygroup_(signUpRequest.getGroup_name());

        Students student = new Students(signUpRequest.getSurname(), signUpRequest.getName(),
                signUpRequest.getFatherland(), signUpRequest.getUsername(), signUpRequest.getForm(),
